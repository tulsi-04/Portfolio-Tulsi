import type { Skill, Experience, Project, PersonalityTrait } from "@shared/schema";
...
export const profileInfo = {
  ...
  bio: `I'm a passionate developer who loves creating beautiful, interactive web experiences. 
With over 6 years of experience in frontend development and a deep fascination with 3D graphics, 
I specialize in building applications that push the boundaries of what's possible on the web.

When I'm not coding, you'll find me exploring the latest in generative art, 
attending tech meetups, or experimenting with new creative coding techniques.`,
